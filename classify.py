...
class DataVectorizer():
    ...
    def __init__(self):
        self.model_path = "not_used_at_the_moment"
...
def train_model(train_data, directory_name, cross_validate = False):
...
def run_experiment():
    ...
    print("Will evaluate files in the directory " + debate_directory)

    train_data = \
        load_files(debate_directory, encoding='utf-8', shuffle=True, random_state=0)
    train_model(train_data, str(debate_directory).replace("/","_").replace("\\","_"))
